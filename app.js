...
const mapaCoords = {
  zona1: { left: "38%", top: "15%" },
  zona2: { left: "43%", top: "12%" },
  zona3: { left: "48%", top:  "7%" },
  zona4: { left: "65%", top: "22%" },
  zona5: { left: "64%", top: "43%" },
  zona6: { left: "57%", top: "57%" },
  zona7: { left: "59%", top: "63%" },
  zona8: { left: "55%", top: "82%" },
  zona9: { left: "32%", top: "22%" }
};

// Información por escena
const infoEscenas = {
  zona1: [
    { titulo: "Zo na 1 - Escena 1", texto: "Información descriptiva de la Zona 1, escena 1." },
